...
public class MlemStuff implements ModInitializer
{
    ...
    public static final ItemGroup HATS = FabricItemGroupBuilder.create(
                    new Identifier("mlemstuff", "hats"))
    ...
    public static ToolItem ChargedSword = new SwordItem(ToolMaterialCharged.INSTANCE, 5, 0.5F, new Item.Settings().group(MlemStuff.ITEM_GROUP));
    ...
    public static final Item ChargedGem = new ChargedGem(new Item.Settings().group(MlemStuff.ITEM_GROUP));

    public static final Item LuckModule = new LuckModule(new Item.Settings().group(MlemStuff.ITEM_GROUP));

    public static final Item FortuneModule = new FortuneModule(new Item.Settings().group(MlemStuff.ITEM_GROUP));

    public static final Block CableWire = new CableWire(FabricBlockSettings.copy(Blocks.REDSTONE_WIRE));

    public static final Block SolarRedstone = new SolarRedstone(FabricBlockSettings.copy(Blocks.DAYLIGHT_DETECTOR));
    ...
    public static final Block Pot = new Pot();

    public static final Block CurtainsWhite = new CurtainsWhite(FabricBlockSettings.copy(Blocks.OAK_FENCE).noCollision());
    ...
    public static final Block NachoHat = new NachoHat(FabricBlockSettings.copy(Blocks.WHEAT).nonOpaque());

    public static final Block SantaHat = new SantaHat(FabricBlockSettings.copy(Blocks.SNOW_BLOCK).nonOpaque());

    public static final Block SodaHat = new SodaHat(FabricBlockSettings.copy(Blocks.SNOW_BLOCK).nonOpaque());

    public static final Block FrogHat = new FrogHat(FabricBlockSettings.copy(Blocks.SNOW_BLOCK).nonOpaque());

    public static final Block PropellerHat = new PropellerHat(FabricBlockSettings.copy(Blocks.SNOW_BLOCK).nonOpaque());
    ...
    public void onInitialize(){
        ...
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "charged_gem"), ChargedGem);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "luck_module"), LuckModule);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "fortune_module"), FortuneModule);

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","cable_wire"), CableWire);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "cable_wire"),
                new BlockItem(CableWire, new Item.Settings().group(MlemStuff.ITEM_GROUP)));

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","solar_redstone"), SolarRedstone);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "solar_redstone"),
                new BlockItem(SolarRedstone, new Item.Settings().group(MlemStuff.ITEM_GROUP)));
        ...
        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","pot_block"), Pot);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "pot_block"),
                new BlockItem(Pot, new Item.Settings().group(MlemStuff.ITEM_GROUP)));
        ...
        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","nacho_hat"), NachoHat);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "nacho_hat"),
                new BlockItem(NachoHat, new FabricItemSettings().group(MlemStuff.HATS)
                        .equipmentSlot(itemStack -> EquipmentSlot.HEAD)
                        .food(new FoodComponent.Builder().hunger(8).saturationModifier(12).snack().meat().build())));

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","santa_hat"), SantaHat);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "santa_hat"),
                new BlockItem(SantaHat, new FabricItemSettings().group(MlemStuff.HATS)
                        .equipmentSlot(itemStack -> EquipmentSlot.HEAD)));

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","soda_hat"), SodaHat);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "soda_hat"),
                new BlockItem(SodaHat, new FabricItemSettings().group(MlemStuff.HATS)
                        .equipmentSlot(itemStack -> EquipmentSlot.HEAD)));

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","frog_hat"), FrogHat);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "frog_hat"),
                new BlockItem(FrogHat, new FabricItemSettings().group(MlemStuff.HATS)
                        .equipmentSlot(itemStack -> EquipmentSlot.HEAD)));

        Registry.register(Registry.BLOCK, new Identifier("mlemstuff","propeller_hat"), PropellerHat);
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "propeller_hat"),
                new BlockItem(PropellerHat, new FabricItemSettings().group(MlemStuff.HATS)
                        .equipmentSlot(itemStack -> EquipmentSlot.HEAD)));
        ...
        Registry.register(Registry.ITEM, new Identifier("mlemstuff", "charged_sword"), ChargedSword);
